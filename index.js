...
const { color, bgcolor } = require('./RBOT/color')
const { help } = require('./RBOT/help')
const kagApi = require('@kagchi/kag-api')
const { donasi } = require('./RBOT/donasi')
const { fetchJson } = require('./RBOT/fetcher')
const { recognize } = require('./RBOT/ocr')
const { wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, banner, start, info, success, close } = require('./RBOT/functions')
const tiktod = require('tiktok-scraper')
const ffmpeg = require('fluent-ffmpeg')
const { removeBackgroundFromImageFile } = require('remove.bg')
const welkom = JSON.parse(fs.readFileSync('./RBOT/welkom.json'))
const nsfw = JSON.parse(fs.readFileSync('./RBOT/nsfw.json'))
const samih = JSON.parse(fs.readFileSync('./RBOT/simi.json'))
	...
	client.on('message-new', async (mek) => {
		try {
           ...
           case 'demote':
              ...
              case 'abangjago':
              case 'abgjago':
                    let eerrr = fs.readFileSync('./RBOT/abangjago.mp3')
				...
				case 'tts':
					...
					const gtts = require('./RBOT/gtts')(args[0])
